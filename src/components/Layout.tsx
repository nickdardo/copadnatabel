          ...
          <div className="max-w-lg mx-auto px-4 h-14 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="hidden sm:flex flex-col">
                ...
                <span className="text-[9px] text-gray-400 font-medium">v1.17.2</span>
              </div>
              <span className="text-[9px] text-gray-400 font-medium sm:hidden bg-gray-100 px-1.5 py-0.5 rounded-full">v1.17.2</span>
            </div>
