...
export const OFFICIAL_BRACKET_2026: OfficialSlot[] = [
  ...
  { match: 73, fase: 'Dezesseis Avos de Final', side: 'A', venue: 'Los Angeles', dateHint: '2026-06-28T19:00:00Z',
    home: { type: 'group_runnerup', group: 'A' }, away: { type: 'group_runnerup', group: 'B' } },
  { match: 74, fase: 'Dezesseis Avos de Final', side: 'A', venue: 'Foxborough', dateHint: '2026-06-29T20:30:00Z',
    home: { type: 'group_winner', group: 'E' }, away: { type: 'best_third', groups: ['A', 'B', 'C', 'D', 'F'] } },
  { match: 75, fase: 'Dezesseis Avos de Final', side: 'A', venue: 'Guadalajara', dateHint: '2026-06-30T01:00:00Z',
    home: { type: 'group_winner', group: 'F' }, away: { type: 'group_runnerup', group: 'C' } },
  { match: 76, fase: 'Dezesseis Avos de Final', side: 'B', venue: 'Houston', dateHint: '2026-06-29T17:00:00Z',
    home: { type: 'group_winner', group: 'C' }, away: { type: 'group_runnerup', group: 'F' } },
  { match: 77, fase: 'Dezesseis Avos de Final', side: 'A', venue: 'East Rutherford', dateHint: '2026-06-30T21:00:00Z',
    home: { type: 'group_winner', group: 'I' }, away: { type: 'best_third', groups: ['C', 'D', 'F', 'G', 'H'] } },
  { match: 78, fase: 'Dezesseis Avos de Final', side: 'B', venue: 'Arlington', dateHint: '2026-06-30T17:00:00Z',
    home: { type: 'group_runnerup', group: 'E' }, away: { type: 'group_runnerup', group: 'I' } },
  { match: 79, fase: 'Dezesseis Avos de Final', side: 'B', venue: 'Cidade do México', dateHint: '2026-07-01T01:00:00Z',
    home: { type: 'group_winner', group: 'A' }, away: { type: 'best_third', groups: ['C', 'E', 'F', 'H', 'I'] } },
  { match: 80, fase: 'Dezesseis Avos de Final', side: 'B', venue: 'Atlanta', dateHint: '2026-07-01T16:00:00Z',
    home: { type: 'group_winner', group: 'L' }, away: { type: 'best_third', groups: ['E', 'H', 'I', 'J', 'K'] } },
  { match: 81, fase: 'Dezesseis Avos de Final', side: 'A', venue: 'Santa Clara', dateHint: '2026-07-02T00:00:00Z',
    home: { type: 'group_winner', group: 'D' }, away: { type: 'best_third', groups: ['B', 'E', 'F', 'I', 'J'] } },
  { match: 82, fase: 'Dezesseis Avos de Final', side: 'A', venue: 'Seattle', dateHint: '2026-07-01T20:00:00Z',
    home: { type: 'group_winner', group: 'G' }, away: { type: 'best_third', groups: ['A', 'E', 'H', 'I', 'J'] } },
  { match: 83, fase: 'Dezesseis Avos de Final', side: 'A', venue: 'Toronto', dateHint: '2026-07-02T23:00:00Z',
    home: { type: 'group_runnerup', group: 'K' }, away: { type: 'group_runnerup', group: 'L' } },
  { match: 84, fase: 'Dezesseis Avos de Final', side: 'A', venue: 'Los Angeles', dateHint: '2026-07-02T19:00:00Z',
    home: { type: 'group_winner', group: 'H' }, away: { type: 'group_runnerup', group: 'J' } },
  { match: 85, fase: 'Dezesseis Avos de Final', side: 'B', venue: 'Vancouver', dateHint: '2026-07-03T18:00:00Z',
    home: { type: 'group_winner', group: 'B' }, away: { type: 'best_third', groups: ['E', 'F', 'G', 'I', 'J'] } },
  { match: 86, fase: 'Dezesseis Avos de Final', side: 'B', venue: 'Miami', dateHint: '2026-07-03T22:00:00Z',
    home: { type: 'group_winner', group: 'J' }, away: { type: 'group_runnerup', group: 'H' } },
  { match: 87, fase: 'Dezesseis Avos de Final', side: 'B', venue: 'Kansas City', dateHint: '2026-07-03T03:00:00Z',
    home: { type: 'group_winner', group: 'K' }, away: { type: 'best_third', groups: ['D', 'E', 'I', 'J', 'L'] } },
  { match: 88, fase: 'Dezesseis Avos de Final', side: 'B', venue: 'Arlington', dateHint: '2026-07-04T01:30:00Z',
    home: { type: 'group_runnerup', group: 'D' }, away: { type: 'group_runnerup', group: 'G' } },

  // ── Oitavas de final (Round of 16) ──
  { match: 89, fase: 'Oitavas de Final', side: 'A', venue: 'Philadelphia', dateHint: '2026-07-04T21:00:00Z',
    home: { type: 'match_winner', match: 74 }, away: { type: 'match_winner', match: 77 } },
  { match: 90, fase: 'Oitavas de Final', side: 'A', venue: 'Houston', dateHint: '2026-07-04T17:00:00Z',
    home: { type: 'match_winner', match: 73 }, away: { type: 'match_winner', match: 75 } },
  { match: 91, fase: 'Oitavas de Final', side: 'B', venue: 'East Rutherford', dateHint: '2026-07-05T20:00:00Z',
    home: { type: 'match_winner', match: 76 }, away: { type: 'match_winner', match: 78 } },
  { match: 92, fase: 'Oitavas de Final', side: 'B', venue: 'Cidade do México', dateHint: '2026-07-06T00:00:00Z',
    home: { type: 'match_winner', match: 79 }, away: { type: 'match_winner', match: 80 } },
  { match: 93, fase: 'Oitavas de Final', side: 'A', venue: 'Dallas', dateHint: '2026-07-06T19:00:00Z',
    home: { type: 'match_winner', match: 83 }, away: { type: 'match_winner', match: 84 } },
  { match: 94, fase: 'Oitavas de Final', side: 'A', venue: 'Seattle', dateHint: '2026-07-07T00:00:00Z',
    home: { type: 'match_winner', match: 81 }, away: { type: 'match_winner', match: 82 } },
  { match: 95, fase: 'Oitavas de Final', side: 'B', venue: 'Atlanta', dateHint: '2026-07-07T16:00:00Z',
    home: { type: 'match_winner', match: 86 }, away: { type: 'match_winner', match: 85 } },
  { match: 96, fase: 'Oitavas de Final', side: 'B', venue: 'Vancouver', dateHint: '2026-07-07T20:00:00Z',
    home: { type: 'match_winner', match: 87 }, away: { type: 'match_winner', match: 88 } },

  // ── Quartas de final ──
  { match: 97, fase: 'Quartas de Final', side: 'A', venue: 'Foxborough', dateHint: '2026-07-09T20:00:00Z',
    home: { type: 'match_winner', match: 89 }, away: { type: 'match_winner', match: 90 } },
  { match: 98, fase: 'Quartas de Final', side: 'A', venue: 'Los Angeles', dateHint: '2026-07-10T19:00:00Z',
    home: { type: 'match_winner', match: 93 }, away: { type: 'match_winner', match: 94 } },
  { match: 99, fase: 'Quartas de Final', side: 'B', venue: 'Miami', dateHint: '2026-07-11T21:00:00Z',
    home: { type: 'match_winner', match: 91 }, away: { type: 'match_winner', match: 92 } },
  { match: 100, fase: 'Quartas de Final', side: 'B', venue: 'Kansas City', dateHint: '2026-07-12T01:00:00Z',
    home: { type: 'match_winner', match: 95 }, away: { type: 'match_winner', match: 96 } },

  // ── Semifinais ──
  { match: 101, fase: 'Semifinais', side: 'A', venue: 'Arlington', dateHint: '2026-07-14T19:00:00Z',
    home: { type: 'match_winner', match: 97 }, away: { type: 'match_winner', match: 98 } },
  { match: 102, fase: 'Semifinais', side: 'B', venue: 'Atlanta', dateHint: '2026-07-15T19:00:00Z',
  ...
  { match: 103, fase: 'Terceiro Lugar', side: null, venue: 'Miami', dateHint: '2026-07-18T21:00:00Z',
    home: { type: 'match_loser', match: 101 }, away: { type: 'match_loser', match: 102 } },
  { match: 104, fase: 'Final', side: null, venue: 'East Rutherford', dateHint: '2026-07-19T19:00:00Z',
