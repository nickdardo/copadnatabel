...
export const OFFICIAL_BRACKET_2026: OfficialSlot[] = [
  ...
  { match: 89, fase: 'Oitavas de Final', side: 'A', venue: 'Philadelphia', dateHint: '2026-07-04T17:00',
    home: { type: 'match_winner', match: 74 }, away: { type: 'match_winner', match: 77 } },
  { match: 90, fase: 'Oitavas de Final', side: 'A', venue: 'Houston', dateHint: '2026-07-04T13:00',
    home: { type: 'match_winner', match: 73 }, away: { type: 'match_winner', match: 75 } },
  { match: 91, fase: 'Oitavas de Final', side: 'B', venue: 'East Rutherford', dateHint: '2026-07-05T16:00',
    home: { type: 'match_winner', match: 76 }, away: { type: 'match_winner', match: 78 } },
  { match: 92, fase: 'Oitavas de Final', side: 'B', venue: 'Cidade do México', dateHint: '2026-07-05T20:00',
    home: { type: 'match_winner', match: 79 }, away: { type: 'match_winner', match: 80 } },
  { match: 93, fase: 'Oitavas de Final', side: 'A', venue: 'Dallas', dateHint: '2026-07-06T15:00',
    home: { type: 'match_winner', match: 83 }, away: { type: 'match_winner', match: 84 } },
  { match: 94, fase: 'Oitavas de Final', side: 'A', venue: 'Seattle', dateHint: '2026-07-06T20:00',
    home: { type: 'match_winner', match: 81 }, away: { type: 'match_winner', match: 82 } },
  { match: 95, fase: 'Oitavas de Final', side: 'B', venue: 'Atlanta', dateHint: '2026-07-07T12:00',
    home: { type: 'match_winner', match: 86 }, away: { type: 'match_winner', match: 88 } },
  { match: 96, fase: 'Oitavas de Final', side: 'B', venue: 'Vancouver', dateHint: '2026-07-07T16:00',
    home: { type: 'match_winner', match: 85 }, away: { type: 'match_winner', match: 87 } },

  // ── Quartas de final ──
  { match: 97, fase: 'Quartas de Final', side: 'A', venue: 'Foxborough', dateHint: '2026-07-09T16:00',
    home: { type: 'match_winner', match: 89 }, away: { type: 'match_winner', match: 90 } },
  { match: 98, fase: 'Quartas de Final', side: 'A', venue: 'Los Angeles', dateHint: '2026-07-10T15:00',
    home: { type: 'match_winner', match: 93 }, away: { type: 'match_winner', match: 94 } },
  { match: 99, fase: 'Quartas de Final', side: 'B', venue: 'Miami', dateHint: '2026-07-11T17:00',
    home: { type: 'match_winner', match: 91 }, away: { type: 'match_winner', match: 92 } },
  { match: 100, fase: 'Quartas de Final', side: 'B', venue: 'Kansas City', dateHint: '2026-07-11T21:00',
    home: { type: 'match_winner', match: 95 }, away: { type: 'match_winner', match: 96 } },

  // ── Semifinais ──
  { match: 101, fase: 'Semifinais', side: 'A', venue: 'Arlington', dateHint: '2026-07-14T15:00',
    home: { type: 'match_winner', match: 97 }, away: { type: 'match_winner', match: 98 } },
  { match: 102, fase: 'Semifinais', side: 'B', venue: 'Atlanta', dateHint: '2026-07-15T15:00',
  ...
  { match: 103, fase: 'Terceiro Lugar', side: null, venue: 'Miami', dateHint: '2026-07-18T17:00',
    home: { type: 'match_loser', match: 101 }, away: { type: 'match_loser', match: 102 } },
  { match: 104, fase: 'Final', side: null, venue: 'East Rutherford', dateHint: '2026-07-19T15:00',
